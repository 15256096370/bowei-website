...
已接入 [51.LA](https://www.51.la) 免费统计，可查看访客的**国家 / 省份 / 城市**分布、来源渠道、浏览页面、停留时长等。

- **代码位置**：全部 13 个页面（中文 7 页 + 英文 6 页）的 `</body>` 之前
- **站点 ID**：`3QwsWSJiQqbFerHG`
- **查看数据**：51.LA 控制台 → 访客分析 → 地域分布
- **注意**：`share.html` 是 0 秒跳转页，未挂统计代码
- **更换账号**：全局搜索 `LA_COLLECT`，替换其下两行 `<script>` 即可
...
| 51.LA 统计代码 | 各页面 `</body>` 前，见「网站统计」章节 |
